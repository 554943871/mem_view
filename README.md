...
[Download memView v0.2.5](https://github.com/554943871/mem_view/releases/tag/v0.2.5)

Direct dmg asset:

[memView_0.2.5_arm64.dmg](https://github.com/554943871/mem_view/releases/download/v0.2.5/memView_0.2.5_arm64.dmg)
...
```bash
xattr -d com.apple.quarantine /path/to/memView_0.2.5_arm64.dmg
open /path/to/memView_0.2.5_arm64.dmg
```
