...
[Download memView v0.2.38](https://github.com/554943871/mem_view/releases/tag/v0.2.38)

Direct dmg asset:

[memView_0.2.38_arm64.dmg](https://github.com/554943871/mem_view/releases/download/v0.2.38/memView_0.2.38_arm64.dmg)
...
```bash
xattr -d com.apple.quarantine /path/to/memView_0.2.38_arm64.dmg
open /path/to/memView_0.2.38_arm64.dmg
```
